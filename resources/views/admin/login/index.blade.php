          ...
          <div class="row g-0">
            <div class="col-lg-6">
              <div class="card-body p-md-5 mx-md-4">
                ...
                @include('admin.alert')
                <form id="validateForm" action="{{ route('admin.login.submit') }}" method="post" name="registerform">
                    @csrf
            ...
            <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
              <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                <button class="btn btn-light btn-lg d-flex align-items-center shadow-sm border rounded-pill px-4 py-2" type="button" disabled>
                  <img src="https://img.icons8.com/color/48/000000/google-logo.png" alt="Google Logo" class="me-2" width="24" height="24">
                  <span class="">Sign in with Google (disabled)</span>
                </button>
              </div>
            </div>
          </div>
